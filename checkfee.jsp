    ...
    <table>
        ...
        try {
            ...
            if (httpSession != null && httpSession.getAttribute("studentid") != null) {
                ...
                PreparedStatement pst = conn.prepareStatement("SELECT tfee, bfee, hfee, ddate FROM studentlogin WHERE studentid = ?");
                pst.setInt(1, studentid);
                ResultSet rs = pst.executeQuery();

                if (rs.next()) {
                    double tufee = rs.getDouble("tfee");
                    double bufee = rs.getDouble("bfee");
                    double hufee = rs.getDouble("hfee");
